...
class P0EFTJanusZ4MasterActionNormalizationGateTests(unittest.TestCase):
    def test_action_normalization_blocks_likelihood_until_full_derivation(self):
        ...
        self.assertFalse(payload["full_upstream_action_normalization_derived"])
        self.assertFalse(payload["action_normalization_gate_passed"])
        self.assertFalse(payload["likelihood_handshake_allowed"])
