...
from scripts.build_p0_eft_janus_z4_master_observed_planck_gr_reference_handshake import build_payload


class P0EFTJanusZ4MasterObservedPlanckGRReferenceHandshakeTests(unittest.TestCase):
    def test_gr_reference_handshake_checks_same_wrapper_without_candidate_replay(self):
        payload = build_payload()

        self.assertEqual(payload["status"], "janus-z4-master-observed-planck-gr-reference-handshake")
