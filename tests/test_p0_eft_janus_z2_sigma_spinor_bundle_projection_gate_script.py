...
class P0EFTJanusZ2SigmaSpinorBundleProjectionGateTests(unittest.TestCase):
    ...
    def test_projection_waits_for_z2sigma_projection_map(self):
        payload = build_payload()
        ...
        self.assertTrue(payload["spinor_bundle_projection_ready"])
        ...
        self.assertTrue(payload["upstream_frontiers"]["plus_minus_spinor_bundle_data"]["ready"])
        self.assertTrue(payload["upstream_frontiers"]["boundary_spinor_restriction"]["ready"])
        self.assertTrue(payload["upstream_frontiers"]["spinor_boundary_projection_map"]["ready"])
