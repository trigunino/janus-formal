...
from scripts.build_p0_eft_janus_z4_weak_surface_branch_archive_gate import build_payload


class P0EFTJanusZ4WeakSurfaceBranchArchiveGateTests(unittest.TestCase):
    def test_weak_surface_branch_is_archived_after_refined_doppler(self):
        payload = build_payload()

        self.assertEqual(payload["status"], "janus-z4-weak-surface-branch-archive-gate")
        ...
        self.assertTrue(payload["archive_weak_surface_branch"])
