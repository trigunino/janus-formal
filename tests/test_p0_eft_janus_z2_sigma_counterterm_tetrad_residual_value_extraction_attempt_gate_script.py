...
class CountertermTetradResidualValueExtractionAttemptGateTests(unittest.TestCase):
    def test_closure_is_boolean_only_and_values_are_not_extractable(self):
        ...
        self.assertEqual(payload["primary_blocker"], "nonlinear_closure_lacks_alpha_res_components")
