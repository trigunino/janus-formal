...
from scripts.build_p0_eft_janus_z2_sigma_active_inputs_to_scale_free_bao_chi2_gate import (
    build_payload,
)
...
class P0EFTJanusZ2SigmaActiveInputsToScaleFreeBAOChi2GateTests(unittest.TestCase):
    def test_missing_inputs_block_scale_free_bao(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            payload = build_payload(
                ...
                scale_free_input_path=tmpdir / "bao_scale_free_inputs.json",
            )
    ...
    def test_strict_active_inputs_block_until_counterterm_is_derived(self):
        ...
        self.assertFalse(payload["active_scale_free_bao_input_valid"])
        self.assertFalse(payload["scale_free_bao_evaluation"])
