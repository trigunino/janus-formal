...
class P0EFTJanusZ4RegenerativeSourceLevelDeltaGateTests(unittest.TestCase):
    def test_source_level_gate_blocks_without_source_equations(self):
        ...
        self.assertFalse(payload["no_stale_source_delta_reuse"])
        ...
        self.assertFalse(payload["strict_source_level_gate_passed"])
