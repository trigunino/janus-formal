...
REPORT_PATH = Path(
    "outputs/reports/p0_eft_janus_z2_null_sigma_llbrane_branch_archive_gate.md"
)
JSON_PATH = Path(
    "outputs/reports/p0_eft_janus_z2_null_sigma_llbrane_branch_archive_gate.json"
)
...
def build_payload() -> dict:
    ...
    return {
        "status": "janus-z2-null-sigma-llbrane-branch-archive-gate",
        "active_core": "Z2_tunnel_Sigma",
        "branch": "Z2_null_Sigma_PT_bridge",
        "archive_decision": "archive_as_viable_state_parameter_extension",
...
def write_reports() -> dict:
    ...
    lines = [
        "# Janus Z2 Null Sigma LL-Brane Branch Archive Gate",
        "",
        f"Archive decision: `{payload['archive_decision']}`",
