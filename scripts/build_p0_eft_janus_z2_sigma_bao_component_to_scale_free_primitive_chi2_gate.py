...
from scripts.build_p0_eft_janus_z2_sigma_bao_component_to_scale_free_split_primitives_gate import (
    build_payload as build_component_to_split_payload,
)
...
REPORT_PATH = Path("outputs/reports/p0_eft_janus_z2_sigma_bao_component_to_scale_free_primitive_chi2_gate.md")
JSON_PATH = Path("outputs/reports/p0_eft_janus_z2_sigma_bao_component_to_scale_free_primitive_chi2_gate.json")
...
def build_payload(
    ...
    component_to_split = build_component_to_split_payload(
    ...
    if not component_to_split["gate_passed"]:
        return {
            "status": "janus-z2-sigma-bao-component-to-scale-free-primitive-chi2-gate",
            "active_core": "Z2_tunnel_Sigma",
            "component_to_split_primitives_passed": False,
            ...
            "gate_passed": False,
            "blocker": component_to_split["blocker"],
        }
    ...
    if not assembler["gate_passed"]:
        return {
            "status": "janus-z2-sigma-bao-component-to-scale-free-primitive-chi2-gate",
            "active_core": "Z2_tunnel_Sigma",
            "component_to_split_primitives_passed": True,
            "primitive_inputs_assembler_passed": False,
            "primitive_chi2_passed": False,
            "bao_chi2_evaluated": False,
            "chi2_DESI_DR2_BAO": None,
...
def write_reports() -> dict:
    ...
    lines = [
        "# Janus Z2/Sigma BAO Component To Scale-Free Primitive Chi2 Gate",
        "",
        f"Component to split primitives passed: `{payload['component_to_split_primitives_passed']}`",
