...
REPORT_PATH = Path("outputs/reports/p0_eft_janus_hat_background_candidate_matrix_gate.md")
JSON_PATH = Path("outputs/reports/p0_eft_janus_hat_background_candidate_matrix_gate.json")
...
def write_reports() -> dict:
    ...
    lines = [
        "# Janus Hat Background Candidate Matrix Gate",
        "",
