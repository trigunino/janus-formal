...
OUTPUT_MANIFEST_PATH = Path("outputs/active_z2_sigma/bao_inputs.json")
REPORT_PATH = Path("outputs/reports/p0_eft_janus_z2_sigma_bao_active_manifest_pipeline_gate.md")
JSON_PATH = Path("outputs/reports/p0_eft_janus_z2_sigma_bao_active_manifest_pipeline_gate.json")
...
def build_payload(
    ...
    if not component_input_path.exists():
        return {
            "status": "janus-z2-sigma-bao-active-manifest-pipeline-gate",
    ...
    written = write_bao_manifest_from_active_component_manifest(component_input_path, output_manifest_path)
    return {
        "status": "janus-z2-sigma-bao-active-manifest-pipeline-gate",
        "active_core": "Z2_tunnel_Sigma",
        "component_manifest": str(component_input_path),
        ...
        "bao_input_manifest_written": True,
...
def write_reports() -> dict:
    ...
    lines = [
        "# Janus Z2/Sigma BAO Active Manifest Pipeline Gate",
        "",
