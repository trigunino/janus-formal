...
REPORT_PATH = Path("outputs/reports/p0_eft_janus_z4_full_derived_slip_carrier_archive_gate.md")
JSON_PATH = Path("outputs/reports/p0_eft_janus_z4_full_derived_slip_carrier_archive_gate.json")
...
def build_payload() -> dict:
    ...
    archive = parallel >= ARCHIVE_THRESHOLD
    return {
        "status": "janus-z4-full-derived-slip-carrier-archive-gate",
        ...
        "full_derived_slip_carrier_tangent": archive,
        "archive_fast": archive,
...
def write_reports() -> dict:
    ...
    lines = [
        "# Janus Z4 Full Derived Slip Carrier Archive Gate",
        "",
        f"Archive fast: `{payload['archive_fast']}`",
