...
REPORT_PATH = Path("outputs/reports/p0_eft_janus_z4_master_observed_planck_gr_reference_handshake_v2.md")
JSON_PATH = Path("outputs/reports/p0_eft_janus_z4_master_observed_planck_gr_reference_handshake_v2.json")
...
def build_payload() -> dict:
    ...
    return {
        "status": "janus-z4-master-observed-planck-gr-reference-handshake-v2",
        ...
        **checks,
        "gr_reference_evaluation_kind": "same_wrapper_convention_and_provenance_handshake_v2",
        ...
        "gr_reference_handshake_v2_passed": all(checks.values()),
        "next_required_gate": "P0EFTJanusZ4MasterObservedPlanckWrapperHandshakeV2Gate"
        if all(checks.values())
        else "repair_observed_planck_gr_reference_handshake_v2",
...
def write_reports() -> dict:
    ...
    lines = [
        "# Janus Z4 Master Observed Planck GR Reference Handshake V2",
        "",
        f"All wrappers available: `{payload['all_observed_wrappers_available']}`",
        f"GR handshake passed: `{payload['gr_reference_handshake_v2_passed']}`",
