...
REPORT_PATH = Path("outputs/reports/p0_eft_janus_z4_master_observed_nonoverlap_accounting_gate.md")
JSON_PATH = Path("outputs/reports/p0_eft_janus_z4_master_observed_nonoverlap_accounting_gate.json")
TRIAL_JSON = Path("outputs/reports/p0_eft_janus_z4_master_observed_planck_diagnostic_trial_gate.json")
...
def build_payload() -> dict:
    ...
    return {
        "status": "janus-z4-master-observed-nonoverlap-accounting-gate",
        ...
        "observed_master_branch_rejected": rejected,
        ...
        "next_required_gate": "P0EFTJanusZ4MasterObservedFailureMapGate"
        if rejected
        else "run_observed_diagnostic_trial"
        if not executed
        else "P0EFTJanusZ4MasterCandidateStabilityGate",
    }
...
def write_reports() -> dict:
    ...
    lines = [
        "# Janus Z4 Master Observed Non-Overlap Accounting Gate",
        "",
        ...
        f"Branch rejected: `{payload['observed_master_branch_rejected']}`",
