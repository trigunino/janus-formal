...
SPECS = [
    ...
    Spec("JPP2017-janus-cosmological-model.pdf", "The Janus Cosmological Model. Fourty years of work", 2017, "bimetric_geodesics", "candidate-new", kind="long synthesis", useful_for="Long synthesis of the full model", note="Good paper-native reference precursor, but not a single journal paper."),
