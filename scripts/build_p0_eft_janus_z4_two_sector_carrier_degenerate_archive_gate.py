...
REPORT_PATH = Path("outputs/reports/p0_eft_janus_z4_two_sector_carrier_degenerate_archive_gate.md")
JSON_PATH = Path("outputs/reports/p0_eft_janus_z4_two_sector_carrier_degenerate_archive_gate.json")


def build_payload() -> dict:
    tangent = tangent_payload()
    archive = bool(tangent["archive_fast"])
    return {
        "status": "janus-z4-two-sector-carrier-degenerate-archive-gate",
        "current_two_sector_source_archived": archive,
        ...
        "variables_gate_history_preserved": True,
        "conservation_bianchi_gate_preserved": True,
        "conservation_bianchi_history_preserved": True,
        "initial_mode_gate_preserved": True,
        "initial_mode_history_preserved": True,
        "linear_evolution_gate_preserved": True,
        "linear_evolution_history_preserved": True,
        "stability_gate_preserved": True,
        "stability_history_preserved": True,
        "source_level_regeneration_history_preserved": True,
        "source_level_history_preserved": True,
...
def write_reports() -> dict:
    ...
    lines = [
        "# Janus Z4 Two-Sector Carrier-Degenerate Archive Gate",
        "",
        f"Archived: `{payload['current_two_sector_source_archived']}`",
