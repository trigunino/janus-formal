...
def build_payload() -> dict:
    ...
    return {
        ...
        "normalization_parameter": 0.65,
        "normalization_symbol": "L_transport",
        "normalization_source": "membrane_transport_safety_bound",
        "full_upstream_action_normalization_derived": action_normalized,
        "normalization_from_z4_action_functional": False,
        "normalization_from_membrane_junction_terms": False,
        "normalization_from_orbifold_boundary_conditions": False,
        "action_normalization_gate_passed": action_normalized,
        "likelihood_handshake_allowed": False,
        "official_planck_trial_allowed": False,
        "candidate_promotion_allowed": False,
        "next_required_gate": "derive_master_transport_normalization_from_z4_action",
