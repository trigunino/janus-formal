...
REPORT_PATH = Path("outputs/reports/cosmological_pm_3d_gaussian_ic.md")
CSV_PATH = Path("outputs/reports/cosmological_pm_3d_gaussian_ic.csv")


def field_summary_for_bodies(bodies, grid_shape: tuple[int, int, int], box_size: float):
...
def main() -> None:
    ...
    final = rows[-1]
    lines = [
        "# Cosmological PM 3D With Gaussian IC",
        "",
        "Prototype 3D comoving PM run from anti-correlated Gaussian two-sector initial conditions.",
        "",
