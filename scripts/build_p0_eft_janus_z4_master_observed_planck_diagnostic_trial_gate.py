...
from scripts.build_p0_eft_janus_z4_master_no_retuning_replay_gate import build_payload as replay_payload
from scripts.run_p0_eft_janus_z4_official_planck_acoustic_driving_delta_trial import LIKELIHOODS, _run_likelihood


REPORT_PATH = Path("outputs/reports/p0_eft_janus_z4_master_observed_planck_diagnostic_trial_gate.md")
JSON_PATH = Path("outputs/reports/p0_eft_janus_z4_master_observed_planck_diagnostic_trial_gate.json")
...
def build_payload(run_observed: bool = False) -> dict:
    ...
    return {
        "status": "janus-z4-master-observed-planck-diagnostic-trial-gate",
        "no_retuning_replay_gate_passed": allowed,
        ...
        "next_required_gate": "P0EFTJanusZ4MasterObservedNonOverlapAccountingGate"
        if execute
...
def write_reports(run_observed: bool = False) -> dict:
    ...
    lines = [
        "# Janus Z4 Master Observed Planck Diagnostic Trial Gate",
        "",
