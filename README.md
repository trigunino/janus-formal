...
- `z2_alpha_primary_observational_endpoint = SN_full_cov_plus_DESI_BAO`
- `z2_alpha_best_SNfullcov_plus_DESI_BAO_q0 = -1e-6_gr_limit_boundary`
- `z2_background_observational_endpoint_verdict = no_go_for_interior_janus_sector`
- `z2_background_observational_branch3_continuation_recommended = False`
- `the_janus_cosmological_model_2024_reference_recreated = True`
- `the_janus_cosmological_model_2024_paper_structured_reference_ready = True`
- `the_janus_cosmological_model_2024_paper_only_branch_ready = True`
- `the_janus_cosmological_model_2024_paper_plus_cited_comparison_branch_ready = True`
- `the_janus_cosmological_model_2024_like_for_like_with_paper = False`
- `the_janus_cosmological_model_2024_paper_explicit_only_reference_ready = True`
- `the_janus_cosmological_model_2024_repo_implicit_closure_forbidden = True`
- `the_janus_cosmological_model_2024_active_two_metric_flrw_reference_object_present = True`
- `the_janus_cosmological_model_2024_active_k_equals_kbar_equals_minus_one_branch_present = True`
- `the_janus_cosmological_model_2024_published_k_equals_kbar_equals_minus_one_branch_present = True`
- `the_janus_cosmological_model_2024_active_global_energy_equation_present = True`
- `the_janus_cosmological_model_2024_active_sector_density_law_present = True`
- `the_janus_cosmological_model_2024_active_two_metric_rhs_present = True`
- `the_janus_cosmological_model_2024_paper_native_observational_anchors_present = True`
- `the_janus_cosmological_model_2024_published_cited_exact_shape_present = False`
- `the_janus_cosmological_model_2024_paper_native_plus_history_present = False`
- `the_janus_cosmological_model_2024_active_bulk_observable_path_present = False`
...
- `janus_complex_reality_boundary_variation_basis_symbolic_ready = True`
- `janus_complex_reality_boundary_variation_basis_active_ready = False`
- `janus_complex_reality_topological_cycle_audit_ready = True`
- `janus_complex_reality_kks_boundary_two_cycle_ready = False`
- `janus_complex_reality_active_embedding_or_compact_phase_route_ready = False`
- `janus_complex_reality_two_exit_evaluation_ready = True`
- `janus_complex_reality_candidate_boundary_phase_space_constructed = True`
- `janus_complex_reality_candidate_boundary_phase_space_physically_accepted = False`
- `janus_complex_reality_candidate_phase_space_matrix_ready = True`
- `janus_complex_reality_quantum_candidate_workbench_ready = True`
- `janus_complex_reality_quantum_candidate_alpha_ready = False`
- `janus_complex_reality_combined_phase_space_candidate_coherent = True`
- `janus_complex_reality_combined_phase_space_candidate_closed = False`
- `janus_complex_reality_cp1_mathematical_candidate_ready = True`
- `janus_complex_reality_cp1_derived_from_janus_pt = False`
- `janus_complex_reality_aroundSigma_action_on_cp1_derived = False`
- `janus_complex_reality_noncentral_spin_lift_search_complete = True`
- `janus_complex_reality_noncentral_spin_lift_derived = False`
- `janus_complex_reality_symbolic_combined_kks_period_nonzero = True`
- `janus_complex_reality_janus_derived_combined_kks_period_nonzero = False`
...
- `janus_quantum_first_boundary_state_branch_opened = True`
- `janus_quantum_first_cp1_labels_available = True`
- `janus_quantum_first_conditional_alpha_spectrum_ready = True`
- `janus_quantum_first_conditional_classical_limit_ready = True`
...
- `published_bimetric_sector_relative_ratio_ready = True`
...
- `rho_plus0_abs_noether_volume_route_declared = True`
- `rho_plus0_abs_ready = False`
