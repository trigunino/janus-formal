# Programme B — audit intégré des blocs restants

## Fermé sans P/E

- point 1 : critère spectral point par point de la racine réelle;
- point 4 : identité de Bianchi covariante de Candidate A minimal;
- point 5 : annulation du flux PT et intégrabilité locale;
- point 6 : critère de Higuchi et surfaces de couplage fort;
- points 7–8 : projecteurs, PPN linéaire et profil Vainshtein réduit.
...
5. La canonisation simultanée des deux cadres est faite. Sur la branche PT,
   ...
   `C2=s²(1+q²)/2`, `C3=s²` et
   `g3=1/[s(6(1+q²))^(3/2)]`. La charge scalaire de matière fournie par P/E
   reste nécessaire seulement pour une valeur numérique absolue de `r_V`.

Le bloc autonome de canonisation Vainshtein est donc fermé.
Les décisions globales restantes dépendent désormais d'un fond ou d'une
géométrie fournis par P/E.
