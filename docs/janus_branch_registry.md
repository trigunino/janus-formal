...
| **P — variational principle** | `lake build JanusFormal.Branches.FundamentalGeometryPVariationalPrinciple` | **green** | compact smooth D8 field base, global diagonal configuration, completed `L²`/PT/trace/Dirichlet, holonomic scalar, diagonal diffeomorphism action, LL throat action, null admissible domain and prior variational gates |
