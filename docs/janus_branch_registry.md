...
| **D8 — topology and representations** | `lake build JanusFormal.Branches.FundamentalGeometryD8TopologyRepresentation` | **green** | free analytic mapping torus, smooth throat embedding, analytic normal line, global algebraic differential-normal comparison and two global smooth-underlier complex `Z4` root lines; smooth differential-normal identification remains open |
