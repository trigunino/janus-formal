...
| **P — variational principle** | `lake build JanusFormal.Branches.FundamentalGeometryPVariationalPrinciple` | **green** | causally compatible global diagonal root/domain/frontier, smooth D8 Candidate-A functional variation, completed `L²` plus graph-`H¹`/conditional trace, fixed-frame holonomic scalar action/variation, diagonal diffeomorphisms, LL throat action and null admissible domain |
