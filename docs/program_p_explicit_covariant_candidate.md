...
| 6. Stability/scheme | explicit spectral interaction indefiniteness, source-mode rejection precursor, dust-witness tangent audit separating a negative ambient Hessian from zero exact constrained variation, and reduced Candidate-A anomaly-proxy scheme-freedom no-go | physical quotient stability, PPN derivation, covariantly admissible counterterms, actual regulated anomalies and a microscopic normalization/finite-part law |
