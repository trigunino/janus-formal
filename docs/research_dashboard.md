...
| --- | --- | --- | --- |
| **D0/D8** | global geometry and normal lift | analytic compact mapping-torus quotients, global smooth throat embedding, sign-clutched analytic normal line, transported analytic differential-normal bundle and total homeomorphism, normal principal `Pin⁻(1) ≃ Z4` bundle and associated roots | package the total smooth comparison, construct non-null/null/joint strata and the ambient tangent Pin/SpinC principal bundles |
...
| **P0/P-A** | reject shortcuts and define relative selection | diagonal Candidate-A domain/variation; deck-invariant Lorentz cocycle plus local frames; geometric twisted normal flux; global scalar weak Euler/Jacobi and static-positive Riesz; linearized BRST; PT-covariant Robin and differential-LL H¹/Riesz/self-adjoint index-zero Fredholm realizations | descend the global general Lorentz tensor/action, intrinsic physical-volume Sobolev trace, nonlinear/BV covariance, Lorentzian strong formula via volume/Stokes, Israel/null junctions, full Candidate-A Hessian and constrained stability |
