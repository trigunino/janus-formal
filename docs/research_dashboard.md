...
| --- | --- | --- | --- |
| **D0/D8** | global geometry and normal lift | analytic compact mapping-torus quotients, exact differential-normal `Diffeomorph`, smooth bundle atlas and causal/joint stratification from any continuous intrinsic normal quadratic form; global product derivative equivalence with exact canonical latitude product/ambient image `(e₀, 0)`, intrinsic cover Lorentz square `1`, fixed-throat orthogonality and spacelike/non-null classification, plus an explicit canonical local quotient-normal coordinate/lift with orthogonality and exact scalar-square metric model; its splitting proves no tangential radical and a nondegenerate smooth intrinsic throat metric; ambient tangent orientation/quadratic transition data, genuine Clifford Spin action, unconditional `Spin(4) → SO(4)` surjectivity/lifting function, and exact reduction of global lifting to one kernel-valued Čech class; normal principal `Pin⁻(1) ≃ Z4` bundle | prove deck/change-of-lift compatibility and glue the local normal lift globally; classify arbitrary general-metric throat restrictions; prove global orientation, trivialize the Čech class and regularize the lifts, then extend to SpinC |
...
| **P0/P-A** | reject shortcuts and define relative selection | exact Sylvester-regular roots now exist unconditionally for every raw `4×4` real matrix with split strictly-positive charpoly; a proof-carrying retained frontier certificate assembles the diagonal, fixed-similarity, double-`J₂`, explicit moving-shear, singular-diagonal and two explicit Jordan-type-change witnesses; the canonical intrinsic `(3,1)` metric has finite nonzero quotient action, unconditional smooth pullback by every D8 self-diffeomorphism, an integrated general-metric scalar action, finite covariance and Noether pairing, weak covariant Euler/flux decomposition, concrete Dirichlet flux cancellation, an unconditional pointwise/measured/two-sector/integrated scalar-stress covariance/exchange certificate, a unified general-Lorentz independent-field PT/exchange packet whose two smooth symmetric general-metric throat traces are pointwise PT/exchange-natural and whose nondegeneracy/no-radical domain is PT/exchange-invariant; the intrinsic metric is proved to lie in that nondegenerate throat domain; genuine collar IPP has an exact intrinsic oriented boundary-flux realization, with a quotient-tangent canonical-collar Green current and conserved nonnegative-mass energy satisfying `E = 2 T_nn`; the canonical local quotient-normal projection/lift is explicit with exact scalar-square metric model; physical-volume graph `H¹`, coarea, canonical trace/operator/Dirichlet/Hilbert renorming, complete D8 time action, global scalar weak Euler/Jacobi and static index-zero Fredholm bridges are green | extend collar IPP to global manifold Stokes and identify the abstract bulk boundary functional, prove four-dimensional covariant stress divergence and extend the collar current to a covariant four-dimensional Noether current; prove deck compatibility and glue the local normal lift globally, identify intrinsic Sobolev sections, then arbitrary matrix-path/singular-frame/general Jordan-type classification and nonpositive/complex residuals, select the physical spectral domain, then construct smooth arbitrary-throat-tensor PT pullback/classify general metric restrictions, antifields/full BV boundary stability and the curved global PDE |
...
| P-A relative uniqueness | yes; finite tangent generators and first-jet graph `H¹`, unconditional canonical trace/Dirichlet/Hilbert renorming, raw split-positive `4×4` Sylvester-regular root selection, unique global IFT-atlas lift on the full strictly-positive real-diagonalizable locus, fixed-similarity, double-Jordan, explicit moving-shear/singular-diagonal zero-frontier control and two explicit Jordan-type-change paths, canonical intrinsic global `(3,1)` metric, finite nonzero quotient action, unconditional arbitrary-diffeomorphism metric pullback, integrated scalar/Noether covariance, weak covariant Euler/flux, concrete Dirichlet cancellation, canonical-collar IPP with exact intrinsic oriented flux realization, pointwise PT/exchange-natural general-metric throat traces with invariant nondegenerate/no-radical domain and a proved nondegenerate intrinsic instance, a quotient-tangent equal-mass Green current, conserved nonnegative-mass autonomous collar energy with exact `E = 2 T_nn`, and an unconditional scalar-stress covariance/exchange certificate, complete D8 time flow, Candidate-A induced variation and static scalar ellipticity bridge | extend root atlases beyond the strictly-positive real-diagonalizable locus to Jordan/nonpositive and physical domains; globalize collar IPP to manifold Stokes and identify the abstract bulk boundary functional, prove four-dimensional covariant stress divergence and extend the collar current to a covariant four-dimensional Noether current; glue the local normal projection, classify arbitrary general-metric throat restrictions and construct smooth arbitrary-tensor throat PT pullback, identify intrinsic Sobolev sections, then arbitrary singular-frame/general Jordan-type and nonpositive classification, parent action, general-metric/nonlocal BV and the curved global PDE |
