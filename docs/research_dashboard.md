...
| --- | --- | --- | --- |
| **D0/D8** | global geometry and normal lift | the effective spacetime and throat quotients carry analytic manifold atlases, analytic PT diffeomorphisms, compactness, a closed smooth throat inclusion with injective differential and rank-one tangent quotient, plus the one-sided complement and normal-line local system | construct the smooth normal `VectorBundle`, non-null/null/joint strata and global Pin/root bundle |
