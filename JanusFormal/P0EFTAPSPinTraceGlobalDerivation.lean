...
theorem aps_pin_index_package_fixes_trace_normalization
    ...
    (h : JanusFormal.P0EFTAPSPinTraceNormalization.APSPinTraceNormalization)
    ...
    JanusFormal.P0EFTAPSPinTraceNormalization.standardTraceNormalizationDerived h := by
  unfold JanusFormal.P0EFTAPSPinTraceNormalization.standardTraceNormalizationDerived
  unfold JanusFormal.P0EFTAPSPinTraceNormalization.apsPinGlobalHypothesis
  exact And.intro
...
theorem aps_pin_global_package_derives_eta_h_lock
  ...
  apply JanusFormal.P0EFTAPSPinTraceNormalization.aps_pin_hypothesis_derives_local_trace_lock h l
