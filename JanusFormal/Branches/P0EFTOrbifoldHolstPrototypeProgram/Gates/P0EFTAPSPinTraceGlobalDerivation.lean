import JanusFormal.Branches.P0EFTOrbifoldHolstPrototypeProgram.Gates.P0EFTAPSPinTraceNormalization
...
theorem aps_pin_index_package_fixes_trace_normalization
    ...
    (h : P0EFTAPSPinTraceNormalization.APSPinTraceNormalization)
    ...
    P0EFTAPSPinTraceNormalization.standardTraceNormalizationDerived h := by
  unfold P0EFTAPSPinTraceNormalization.standardTraceNormalizationDerived
  unfold P0EFTAPSPinTraceNormalization.apsPinGlobalHypothesis
  exact And.intro
...
theorem aps_pin_global_package_derives_eta_h_lock
  ...
  apply P0EFTAPSPinTraceNormalization.aps_pin_hypothesis_derives_local_trace_lock h l
  Â· exact aps_pin_index_package_fixes_trace_normalization
