...
theorem full_linear_mode_closure_closed
  ...
  constructor
  · exact chain_gives_tensor_stability c.chain
  constructor
  · exact chain_gives_visible_luminality c.chain
  constructor
  · exact c.scalar.stable
  constructor
  · exact c.vector.stable
  constructor
  · exact no_aether_instability_reintroduced_by_scalar c.scalar
  · exact no_aether_instability_reintroduced_by_vector c.vector
