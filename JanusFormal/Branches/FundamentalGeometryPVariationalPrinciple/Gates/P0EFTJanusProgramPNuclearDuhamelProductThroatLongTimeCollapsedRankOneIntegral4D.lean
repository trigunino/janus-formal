...
theorem weightedIntegral_hasDerivAt
    ...
    (parameter : Real) :
    HasDerivAt
      data.toLongTimeExponentialDominatedCollapsedRankOneIntegral.toDominatedCollapsedRankOneIntegral.toCollapsedRankOneIntegral.weighted.toWeightedHeatTraceVariation.contribution
      (-(∫ time in Set.Ioi start,
        extendedDuhamelTrace nuclear parameter time)) parameter :=
  data.toLongTimeExponentialDominatedCollapsedRankOneIntegral.weightedIntegral_hasDerivAt
    parameter
...
theorem scalarIntegral_eq_intrinsicTrace
  ...
  data.toLongTimeExponentialDominatedCollapsedRankOneIntegral.scalarIntegral_eq_intrinsicTrace
    parameter
