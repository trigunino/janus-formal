...
namespace P0EFTJanusProgramPT12CandidateAReducedBRSTPairing4D
...
theorem candidateAReducedBRSTPhysical_pairing_project
    (x y : CandidateACoupledBRSTHilbert period hPeriod configuration data) :
    ...
    inner Real (candidateACoupledBRSTPhysicalColumn period hPeriod configuration data analysis realization
      ...
      (candidateACoupledBRSTPhysicalLift period hPeriod configuration data analysis y) := by
  change inner Real (quotientPhysicalRiesz period hPeriod configuration data analysis realization
    plusBase minusBase hBase hCenter physical
    (candidateAReducedBRSTPhysicalLift period hPeriod configuration data analysis
      (candidateABRSTQuotientMap period hPeriod configuration data x)))
    (candidateAReducedBRSTPhysicalLift period hPeriod configuration data analysis
      (candidateABRSTQuotientMap period hPeriod configuration data y)) = _
  rw [candidateAReducedBRSTPhysicalLift_project, candidateAReducedBRSTPhysicalLift_project,
    quotientPhysicalRiesz_pairing]
...
theorem candidateAReducedBRSTOperator_pairing
    ...
    inner Real (candidateAReducedBRSTOperator period hPeriod configuration data analysis realization
    ...
    inner Real (candidateAAbelianMixedOperator period hPeriod data
      ⟨x.val.snd, (candidateAReducedBRSTOperator_domain_iff period hPeriod configuration data analysis realization
...
theorem candidateAReducedBRSTOperator_pairing_project
  ...
  conv_rhs => rw [candidateACoupledBRSTOperator_pairing]
  rw [candidateAReducedBRSTOperator_pairing]
...
end P0EFTJanusProgramPT12CandidateAReducedBRSTPairing4D
end JanusFormal
