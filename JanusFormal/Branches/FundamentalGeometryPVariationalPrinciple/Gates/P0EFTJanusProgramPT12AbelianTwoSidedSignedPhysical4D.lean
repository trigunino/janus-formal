...
/-! Exact global H11 and augmented columns after completed Lorenz and ghost changes. -/
namespace JanusFormal
namespace P0EFTJanusProgramPT12AbelianTwoSidedSignedPhysical4D
...
open P0EFTJanusProgramPT12AbelianTwoSidedGhostPhysical4D
open P0EFTJanusProgramPT12AbelianTwoSidedSignedPairing4D
open P0EFTJanusProgramPT12AbelianLorenzShearPhysical4D

/-- The full physical column survives both continuous changes of coordinates. -/
theorem abelianTwoSidedSignedRealization_physicalColumn
    ...
    quotientAbelianPhysicalColumn period hPeriod configuration data analysis realization
      ...
      (abelianTwoSidedSignedRealization period hPeriod
        (globalCandidateAMetricBySector period hPeriod data) vector) =
    quotientAbelianPhysicalColumn period hPeriod configuration data analysis realization
      plusBase minusBase hBase hCenter physical
      (abelianTwoSidedForget period hPeriod (globalCandidateAMetricBySector period hPeriod data) vector) :=
  (quotientAbelianPhysicalColumn_lorenzShear period hPeriod configuration data analysis realization
    plusBase minusBase hBase hCenter physical
    (abelianTwoSidedSignedReadout period hPeriod configuration data vector)).trans
      (abelianTwoSidedSignedReadout_physicalColumn period hPeriod configuration data analysis realization
        plusBase minusBase hBase hCenter physical vector)

/-- An operator column in the entire reduced common Hilbert space, hence with
arbitrary completed tests in every sector. -/
theorem abelianTwoSidedSignedRealization_augmented_column
  ...
  rw [quotientAbelian_augmented_column, abelianTwoSidedSignedRealization_physicalColumn]

end
end
end P0EFTJanusProgramPT12AbelianTwoSidedSignedPhysical4D
end JanusFormal
