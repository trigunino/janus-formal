import JanusFormal.Branches.FundamentalGeometryPVariationalPrinciple.Gates.P0EFTJanusGlobalMatterMultipletAffineTaylor4D
...
namespace P0EFTJanusFullMatterRobinTrueLLExactTaylor4D
...
/-- Exact Taylor reconstruction of the same assembled matter, Robin, and true
three-slot PT LL action along one synchronized full direction. -/
    ...
    globalMatterMultipletAction period hPeriod matterData
      ...
      fullMatterRobinTrueLLAction period hPeriod matterData kPlus kMinus bulkPlus
        ...
        t ^ 4 * globalPTFullLLTaylorQuartic period hPeriod frame fields
          direction.llAuxMetric (fullDirectionLLVariation period hPeriod direction)
          llMeasure := by
  rw [globalMatterMultipletAction_affine_exact_taylor period hPeriod,
    robinJunctionAction_affine_exact_taylor period hPeriod,
    globalPTAction_fullDirection_exact_taylor period hPeriod]
  unfold fullMatterRobinTrueLLAction fullMatterRobinTrueLLEuler
    globalMatterRobinFullLLHessian fullLLEuler
  ring

end
end P0EFTJanusFullMatterRobinTrueLLExactTaylor4D
end JanusFormal
