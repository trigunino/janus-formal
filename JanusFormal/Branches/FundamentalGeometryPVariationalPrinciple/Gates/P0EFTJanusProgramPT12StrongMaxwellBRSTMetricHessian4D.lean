...
namespace P0EFTJanusProgramPT12StrongMaxwellBRSTMetricHessian4D
...
open P0EFTJanusProgramPT12MaxwellMetricHessianTransport4D
...
def strongMaxwellPlusMetricHessian : Real := by
...
theorem strongMaxwellPlusMetricHessian_eq_native :
    ...
    couplings.plusMaxwellScale * nativeMobileMaxwellHessian period hPeriod plusBase
      ...
      (regularGeneralMetricC2SmoothDirection period hPeriod plusBase (test.metricPerturbation .plus), 0) := by
  letI := globalMinimalPhysicalPairedMetricGaugeLLStrongNormedAddCommGroup
    period hPeriod configuration data analysis realization plusBase minusBase
      (canonicalDivergenceFreeLLFrame period hPeriod)
  letI := globalMinimalPhysicalPairedMetricGaugeLLStrongNormedSpace
  ...
  simp only [globalMinimalPhysicalPairedMetricGaugeLLStrongOldCoreCLM_apply,
    pairedPlusProjection_diffeomorphismCore] at h
  exact h
def strongMaxwellMinusMetricHessian : Real := by
  letI := globalMinimalPhysicalPairedMetricGaugeLLStrongNormedAddCommGroup
    period hPeriod configuration data analysis realization plusBase minusBase
      (canonicalDivergenceFreeLLFrame period hPeriod)
  letI := globalMinimalPhysicalPairedMetricGaugeLLStrongNormedSpace
...
theorem strongMaxwellMinusMetricHessian_eq_native :
    ...
    couplings.minusMaxwellScale * nativeMobileMaxwellHessian period hPeriod minusBase
      ...
      (regularGeneralMetricC2SmoothDirection period hPeriod minusBase (test.metricPerturbation .minus), 0) := by
  letI := globalMinimalPhysicalPairedMetricGaugeLLStrongNormedAddCommGroup
    period hPeriod configuration data analysis realization plusBase minusBase
      (canonicalDivergenceFreeLLFrame period hPeriod)
  letI := globalMinimalPhysicalPairedMetricGaugeLLStrongNormedSpace
  ...
  have h := strongMaxwellMinusActionHessian_eq_native period hPeriod configuration data analysis realization
    ...
    (diagonalExtendedBulkMinimalPhysicalTangentLinearMap period hPeriod configuration data analysis
      (diffeomorphismCore period hPeriod configuration analysis test))
  simp only [globalMinimalPhysicalPairedMetricGaugeLLStrongOldCoreCLM_apply,
    pairedMinusProjection_diffeomorphismCore] at h
  exact h

theorem strongMaxwellPlusMetricHessian_eq_transport :
    strongMaxwellPlusMetricHessian period hPeriod configuration data analysis realization
      plusBase minusBase hBase field test =
    couplings.plusMaxwellScale * nativeMaxwellMetricTransportHessian period hPeriod plusBase
      (regularFrameGaugePotentialFromCoefficients period hPeriod plusBase configuration.physical.coefficientFields.gauge.1)
  ...
  rw [strongMaxwellPlusMetricHessian_eq_native, nativeMobileMaxwellHessian_metric_metric_transport]
theorem strongMaxwellMinusMetricHessian_eq_transport :
    strongMaxwellMinusMetricHessian period hPeriod configuration data analysis realization
      plusBase minusBase hBase field test =
    couplings.minusMaxwellScale * nativeMaxwellMetricTransportHessian period hPeriod minusBase
      (regularFrameGaugePotentialFromCoefficients period hPeriod minusBase configuration.physical.coefficientFields.gauge.2)
  ...
  rw [strongMaxwellMinusMetricHessian_eq_native, nativeMobileMaxwellHessian_metric_metric_transport]

end
end P0EFTJanusProgramPT12StrongMaxwellBRSTMetricHessian4D
end JanusFormal
