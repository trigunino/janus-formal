...
structure GlobalHessianPreferredFiveSectorH14D11CompleteSpectralReferenceData
  ...
  baseAssembly : ReferenceNuclearHeatFinitePartFullySpectralAssemblyData
...
theorem global_hessian_preferred_five_sector_H14_D11_complete_spectral_reference_atlas_gate
    ...
    (∀ index parameter,
      HasDerivAt (spectral.localAssembly index).countertermContribution
        ((spectral.localAssembly index).spectralBoundary.countertermVariation.
  ...
  have hFull :=
    GlobalHessianPreferredFiveSectorH14D11FullySpectralReferenceData.
      global_hessian_preferred_five_sector_H14_D11_fully_spectral_reference_atlas_gate
        period hPeriod sliceMeasure shortCutoffFilter longCutoffFilter input
          natural frame full zeroTrace
  exact
    ⟨spectral.baseAssembly.spectralBoundary.
        hasDerivAt_countertermContribution,
      fun index =>
        (spectral.localAssembly index).spectralBoundary.
          hasDerivAt_countertermContribution,
      hFull.1,
      hFull.2.1,
      hFull.2.2.1,
