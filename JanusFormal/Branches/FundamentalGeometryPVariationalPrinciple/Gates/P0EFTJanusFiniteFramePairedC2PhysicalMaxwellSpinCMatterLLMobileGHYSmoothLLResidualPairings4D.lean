import JanusFormal.Branches.FundamentalGeometryPVariationalPrinciple.Gates.P0EFTJanusFiniteFramePairedC2PhysicalMaxwellSpinCMatterLLMobileGHYSmoothLLDerivative4D
...
/-! # Smooth LL residual pairings inside the mobile GHY product -/

namespace JanusFormal
namespace P0EFTJanusFiniteFramePairedC2PhysicalMaxwellSpinCMatterLLMobileGHYSmoothLLResidualPairings4D
...
/-- The mobile-GHY Euler covector on a pure smooth LL auxiliary-metric test
is the explicit auxiliary-metric strong-residual pairing. -/
theorem finiteFramePairedC2PhysicalMaxwellSpinCMatterLLMobileGHYEuler_pure_smooth_llAuxMetric_eq_residualPairing
    ...
    _ = fullLLEuler period hPeriod
      ...
      finiteFramePairedC2PhysicalMaxwellSpinCMatterLLMobileGHYEuler_apply_pure_smooth_ll
        period hPeriod geometry frame hRegular couplings boundaryBase data
          einsteinScale interactionScale coefficients hTransverse oldInput
          fields ghyInput hInput
          (regularGeneralMetricC2PairedMinimalPhysicalStrongLLAPIDirection
            period hPeriod
            (regularGeneralMetricC2PairedMinimalPhysicalStrongLLAuxMetricThreeSlotTest
              period hPeriod test))
...
/-- The mobile-GHY Euler covector on a pure smooth LL measure test is the
explicit measure strong-residual pairing. -/
theorem finiteFramePairedC2PhysicalMaxwellSpinCMatterLLMobileGHYEuler_pure_smooth_llMeasure_eq_residualPairing
    {configuration : GlobalFieldConfiguration period hPeriod}
    {NonNullFace NullFace : Type*} [Fintype NonNullFace] [Fintype NullFace]
    (data : GlobalCandidateAActionData period hPeriod configuration couplings
      NonNullFace NullFace)
...
/-- The mobile-GHY Euler covector on a pure smooth LL field test is the
existing weak LL residual pairing. -/
theorem finiteFramePairedC2PhysicalMaxwellSpinCMatterLLMobileGHYEuler_pure_smooth_llField_eq_weakResidualPairing
    {configuration : GlobalFieldConfiguration period hPeriod}
    {NonNullFace NullFace : Type*} [Fintype NonNullFace] [Fintype NullFace]
    (data : GlobalCandidateAActionData period hPeriod configuration couplings
      NonNullFace NullFace)
        ...
        period hPeriod geometry frame hRegular couplings boundaryBase data
          ...
          (regularGeneralMetricC2PairedMinimalPhysicalStrongLLAPIDirection
            ...
            (regularGeneralMetricC2PairedMinimalPhysicalStrongLLFieldThreeSlotTest
              period hPeriod test))
    _ = _ :=
      fullLLEuler_pureStrongLLField_eq_weakLLEulerOperator period hPeriod fields
        test

end
end P0EFTJanusFiniteFramePairedC2PhysicalMaxwellSpinCMatterLLMobileGHYSmoothLLResidualPairings4D
end JanusFormal
