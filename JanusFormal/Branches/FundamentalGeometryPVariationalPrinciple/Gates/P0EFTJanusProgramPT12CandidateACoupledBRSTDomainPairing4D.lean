...
namespace P0EFTJanusProgramPT12CandidateACoupledBRSTDomainPairing4D
...
theorem candidateACoupledBRSTOperator_pairing
    ...
    inner Real (candidateAAbelianMixedOperator period hPeriod data
      ⟨x.val.snd, (candidateACoupledBRSTOperator_domain_iff period hPeriod configuration data analysis realization
...
end P0EFTJanusProgramPT12CandidateACoupledBRSTDomainPairing4D
end JanusFormal
