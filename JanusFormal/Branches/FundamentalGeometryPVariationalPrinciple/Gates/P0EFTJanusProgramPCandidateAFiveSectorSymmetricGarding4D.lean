...
theorem candidateA_five_sector_symmetric_garding_gate
  ...
  change 0 < data.toQuadraticGardingData.margin ∧
    ∀ vector : E,
      data.toQuadraticGardingData.margin * ‖vector‖ ^ 2 ≤
        data.toQuadraticGardingData.principalEnergy vector
  exact data.toQuadraticGardingData.finite_sector_quadratic_garding_gate
