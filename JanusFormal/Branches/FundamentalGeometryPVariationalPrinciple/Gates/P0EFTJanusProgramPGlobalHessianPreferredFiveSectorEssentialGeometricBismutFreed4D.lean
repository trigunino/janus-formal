...
/-!
# Essential geometric inputs for the preferred Candidate-A Bismut--Freed theorem

Program P already supplies the determinant line, metric, trace connection,
spectral-cut descent and circle holonomy.  This preferred interface retains
only the genuinely external D11 family geometry, connection comparison and
families-index curvature theorem.
-/

namespace JanusFormal
namespace P0EFTJanusProgramPGlobalHessianPreferredFiveSectorEssentialGeometricBismutFreed4D
...
/-- Minimal genuine geometric input remaining after the Program-P determinant
and Quillen layers have been constructed. -/
structure GlobalHessianPreferredFiveSectorEssentialGeometricBismutFreedData4D
...
end P0EFTJanusProgramPGlobalHessianPreferredFiveSectorEssentialGeometricBismutFreed4D
end JanusFormal
