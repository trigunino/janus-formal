...
namespace P0EFTJanusProgramPT12CandidateACanonicalMatterSmooth4D
...
def candidateACanonicalMatterSmooth : CandidateAFourSectorSmoothFields period hPeriod configuration analysis →ₗ[Real]
  ...
  (WithLp.prodContinuousLinearEquiv 2 Real
    ...
    (ProgramPPrimitiveSpinCMatterHilbert)).symm.toLinearMap.comp
      ((candidateABRSTLLSmooth period hPeriod configuration data analysis).prodMap
        (matterCanonicalFiniteEmbedding))

theorem candidateACanonicalMatterSmooth_denseRange :
    DenseRange (candidateACanonicalMatterSmooth period hPeriod configuration data analysis) := by
  have h := (candidateABRSTLLSmooth_denseRange period hPeriod configuration data analysis).prodMap
    (matterCanonicalFiniteEmbedding_denseRange)
  exact (WithLp.prodContinuousLinearEquiv 2 Real
    (CandidateABRSTLLHilbert period hPeriod configuration data)
    (ProgramPPrimitiveSpinCMatterHilbert)).symm.surjective.denseRange.comp h
    (WithLp.prodContinuousLinearEquiv 2 Real
      (CandidateABRSTLLHilbert period hPeriod configuration data)
      (ProgramPPrimitiveSpinCMatterHilbert)).symm.continuous
...
def candidateACanonicalMatterSmoothDomain
  ...
  ⟨WithLp.toLp 2
      ((candidateABRSTLLSmoothDomain period hPeriod configuration data analysis realization
        ...
        matterCanonicalFiniteEmbedding field.2),
    (productOperator_domain_iff _ _ _).mpr
      ⟨(candidateABRSTLLSmoothDomain period hPeriod configuration data analysis realization
        ...
        (matterCanonicalFiniteDomain period hPeriod couplings.matterMassSquared field.2).property⟩⟩

theorem candidateACanonicalMatterSmoothDomain_value
    (field : CandidateAFourSectorSmoothFields period hPeriod configuration analysis) :
    (candidateACanonicalMatterSmoothDomain period hPeriod configuration data analysis realization
      ...
      candidateACanonicalMatterSmooth period hPeriod configuration data analysis field := by
...
end P0EFTJanusProgramPT12CandidateACanonicalMatterSmooth4D
end JanusFormal