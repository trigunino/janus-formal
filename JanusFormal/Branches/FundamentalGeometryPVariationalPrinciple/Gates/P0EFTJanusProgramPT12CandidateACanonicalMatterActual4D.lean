...
namespace P0EFTJanusProgramPT12CandidateACanonicalMatterActual4D
...
theorem candidateACanonicalMatterOperator_smooth_actual_pairing
  ...
  have hPair := candidateACanonicalMatterOperator_pairing period hPeriod configuration data analysis realization
    plusBase minusBase hBase hCenter physical hMetric hWeights
    (candidateACanonicalMatterSmoothDomain period hPeriod configuration data analysis realization
      plusBase minusBase hBase hCenter physical hMetric hWeights x)
    (candidateACanonicalMatterSmooth period hPeriod configuration data analysis y)
  have hBRST := candidateABRSTLLOperator_smooth_sameAction_pairing period hPeriod configuration data analysis realization
    plusBase minusBase hBase hCenter physical hMetric hWeights hZero x.1.1 y.1.1 x.1.2 y.1.2
  have hMatter := matterCanonicalOperator_finite_pairing period hPeriod couplings.matterMassSquared x.2 y.2
  exact (hPair.trans (congrArg₂ (fun r s : Real => r + s) hBRST hMatter)).trans
...
end P0EFTJanusProgramPT12CandidateACanonicalMatterActual4D
end JanusFormal