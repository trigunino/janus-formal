...
/-!
# Natural D11 sector family from a basepoint frame

Basepoint operator commutation is transported to every parameter by the chosen
represented frame.  Pairwise admissible isomorphisms are unnecessary.
-/

namespace JanusFormal
namespace P0EFTJanusProgramPGlobalHessianPreferredFiveSectorD11BasepointFrameNaturalEllipticSectorOperatorFamilyAdapter4D
...
/-- Build the natural five-sector family from the chosen `0 → parameter`
frame. -/
def globalHessianPreferredFiveSectorD11NaturalEllipticSectorOperatorFamily_of_basepointFrame
...
end P0EFTJanusProgramPGlobalHessianPreferredFiveSectorD11BasepointFrameNaturalEllipticSectorOperatorFamilyAdapter4D
end JanusFormal
