...
namespace P0EFTJanusProgramPT12CandidateAFourSectorPairing4D
...
include hZero in
/-- Both BRST sectors with H11, the full LL Hessian, and the signed matter Hessian. -/
theorem candidateAFourSectorOperator_smooth_sameAction_pairing
  ...
  rw [candidateAFourSectorOperator_pairing]
  apply congrArg₂ (fun r s : Real => r + s)
  · exact candidateABRSTLLOperator_smooth_sameAction_pairing period hPeriod configuration data analysis realization
...
end P0EFTJanusProgramPT12CandidateAFourSectorPairing4D
end JanusFormal