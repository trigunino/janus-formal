...
def globalCandidateAHessianConstructiveChart
  ...
  diracGreenClosureChart period hPeriod configuration data analysis
    (globalCandidateAHessianConstructiveReducedFamily period hPeriod
...
def globalCandidateAHessianConstructivePhysicalExtension
  ...
  globalCandidateASevenPhysicalCommonDomainExtension_of_bound period hPeriod
    configuration data analysis
      ...
      (globalCandidateAHessianConstructiveSameAction period hPeriod
        configuration data analysis family)
      (globalCandidateAHessianConstructivePhysicalBound period hPeriod
...
def globalCandidateAHessianConstructiveAnalyticInputs
  ...
  physicalBound := globalCandidateAHessianConstructivePhysicalBound period
    hPeriod configuration data analysis family bounds
  parametrix := globalCandidateAHessianConstructiveParametrix period hPeriod
