...
namespace P0EFTJanusProgramPT12DiffeomorphismH11Core4D
...
attribute [local irreducible] diffeomorphismH11Smooth

/-- H11 on the faithful L2 smooth core; its target is the entire common Hilbert space. -/
def diffeomorphismH11Core : DiffeomorphismL2 period hPeriod (globalCandidateAMetricBySector period hPeriod data .plus) →ₗ.[Real] CommonAugmentedHilbert period hPeriod configuration data analysis :=
...
theorem diffeomorphismH11Core_domain : (diffeomorphismH11Core period hPeriod configuration data analysis realization plusBase minusBase hBase hCenter physical).domain = (diffeomorphismL2Smooth period hPeriod (globalCandidateAMetricBySector period hPeriod data .plus)).range :=
  injectiveSmoothColumn_domain (D := GlobalCandidateADiagonalDiffeomorphismBRSTState period hPeriod) (E := DiffeomorphismL2 period hPeriod (globalCandidateAMetricBySector period hPeriod data .plus)) (F := CommonAugmentedHilbert period hPeriod configuration data analysis) (diffeomorphismL2Smooth period hPeriod (globalCandidateAMetricBySector period hPeriod data .plus)) (diffeomorphismH11Smooth period hPeriod configuration data analysis realization plusBase minusBase hBase hCenter physical) (diffeomorphismL2Smooth_injective period hPeriod (globalCandidateAMetricBySector period hPeriod data .plus))

def diffeomorphismH11SmoothDomain (field : GlobalCandidateADiagonalDiffeomorphismBRSTState period hPeriod) : (diffeomorphismH11Core period hPeriod configuration data analysis realization plusBase minusBase hBase hCenter physical).domain :=
  ⟨(diffeomorphismL2Smooth period hPeriod (globalCandidateAMetricBySector period hPeriod data .plus)) field, ⟨field, rfl⟩⟩

theorem diffeomorphismH11Core_smooth (field : GlobalCandidateADiagonalDiffeomorphismBRSTState period hPeriod) :
    diffeomorphismH11Core period hPeriod configuration data analysis realization plusBase minusBase hBase hCenter physical (diffeomorphismH11SmoothDomain period hPeriod configuration data analysis realization plusBase minusBase hBase hCenter physical field) = (diffeomorphismH11Smooth period hPeriod configuration data analysis realization plusBase minusBase hBase hCenter physical) field :=
  injectiveSmoothColumn_smooth (D := GlobalCandidateADiagonalDiffeomorphismBRSTState period hPeriod) (E := DiffeomorphismL2 period hPeriod (globalCandidateAMetricBySector period hPeriod data .plus)) (F := CommonAugmentedHilbert period hPeriod configuration data analysis) (diffeomorphismL2Smooth period hPeriod (globalCandidateAMetricBySector period hPeriod data .plus)) (diffeomorphismH11Smooth period hPeriod configuration data analysis realization plusBase minusBase hBase hCenter physical) (diffeomorphismL2Smooth_injective period hPeriod (globalCandidateAMetricBySector period hPeriod data .plus)) field

theorem diffeomorphismH11Core_graph :
    (diffeomorphismH11Core period hPeriod configuration data analysis realization plusBase minusBase hBase hCenter physical).graph = ((diffeomorphismL2Smooth period hPeriod (globalCandidateAMetricBySector period hPeriod data .plus)).prod (diffeomorphismH11Smooth period hPeriod configuration data analysis realization plusBase minusBase hBase hCenter physical)).range :=
  injectiveSmoothColumn_graph (D := GlobalCandidateADiagonalDiffeomorphismBRSTState period hPeriod) (E := DiffeomorphismL2 period hPeriod (globalCandidateAMetricBySector period hPeriod data .plus)) (F := CommonAugmentedHilbert period hPeriod configuration data analysis) (diffeomorphismL2Smooth period hPeriod (globalCandidateAMetricBySector period hPeriod data .plus)) (diffeomorphismH11Smooth period hPeriod configuration data analysis realization plusBase minusBase hBase hCenter physical) (diffeomorphismL2Smooth_injective period hPeriod (globalCandidateAMetricBySector period hPeriod data .plus))

theorem diffeomorphismH11Core_denseDomain :
    Dense ((diffeomorphismH11Core period hPeriod configuration data analysis realization plusBase minusBase hBase hCenter physical).domain : Set (DiffeomorphismL2 period hPeriod (globalCandidateAMetricBySector period hPeriod data .plus))) :=
...
theorem diffeomorphismH11Core_pairing (field : GlobalCandidateADiagonalDiffeomorphismBRSTState period hPeriod) (test : CommonAugmentedHilbert period hPeriod configuration data analysis) :
    inner Real (diffeomorphismH11Core period hPeriod configuration data analysis realization plusBase minusBase hBase hCenter physical (diffeomorphismH11SmoothDomain period hPeriod configuration data analysis realization plusBase minusBase hBase hCenter physical field)) test =
      physical.form (diffeomorphismPhysicalSmoothLift period hPeriod configuration data analysis field) test := by
  rw [diffeomorphismH11Core_smooth, diffeomorphismH11Smooth_pairing]

end
end
end P0EFTJanusProgramPT12DiffeomorphismH11Core4D
end JanusFormal
