...
structure ReferenceNuclearDuhamelGreenFullySpectralBoundaryLimitsData
  ...
  shortTime : NuclearDuhamelCollapsedRankOneIntegralData.{e, i, s}
    sliceMeasure nuclear shortTimeRegion
  longTime : NuclearDuhamelCollapsedRankOneIntegralData.{e, i, s}
    sliceMeasure nuclear longTimeRegion
    ...
    data.countertermVariation.derivative parameter -
        (∫ time in shortTimeRegion,
          P0EFTJanusProgramPNuclearHeatDuhamelWeightedIntegral4D.NuclearHeatDuhamelTraceVariationData.extendedDuhamelTrace
            nuclear parameter time) -
        (∫ time in longTimeRegion,
          P0EFTJanusProgramPNuclearHeatDuhamelWeightedIntegral4D.NuclearHeatDuhamelTraceVariationData.extendedDuhamelTrace
            nuclear parameter time) =
      data.toCollapsedBoundaryLimits.toCollapsedBoundary.toBoundaryMatching.toOperatorIdentity.logarithmicTrace
        parameter :=
