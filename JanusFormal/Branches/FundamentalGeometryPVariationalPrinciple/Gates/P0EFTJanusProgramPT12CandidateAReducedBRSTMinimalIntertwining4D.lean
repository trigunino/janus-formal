...
import JanusFormal.Branches.FundamentalGeometryPVariationalPrinciple.Gates.P0EFTJanusProgramPT12CandidateAReducedBRSTMinimalPairing4D
...
import JanusFormal.Branches.FundamentalGeometryPVariationalPrinciple.Gates.P0EFTJanusProgramPT12CandidateAReducedBRSTMinimal4D
...
import JanusFormal.Branches.FundamentalGeometryPVariationalPrinciple.Gates.P0EFTJanusProgramPT12CandidateACoupledBRSTMinimal4D
...
namespace P0EFTJanusProgramPT12CandidateAReducedBRSTMinimalIntertwining4D
...
open P0EFTJanusProgramPT12CandidateACoupledBRSTMinimal4D

open P0EFTJanusProgramPT12CandidateAReducedBRSTMinimal4D
open P0EFTJanusProgramPT12CandidateAReducedBRSTPairing4D

open P0EFTJanusProgramPT12CandidateAReducedBRSTMinimalPairing4D
open P0EFTJanusProgramPT12CandidateAReducedBRSTIntertwining4D
open P0EFTJanusProgramPT12QuotientPairingIntertwiner4D

open P0EFTJanusProgramPT12CandidateACoupledBRSTMinimalActual4D
...
theorem candidateAReducedBRSTMinimal_intertwining
    (x : (candidateACoupledBRSTMinimal period hPeriod configuration data analysis realization
      plusBase minusBase hBase hCenter physical).domain) :
    candidateAReducedBRSTMinimal period hPeriod configuration data analysis realization
      ...
      ⟨candidateABRSTQuotientMap period hPeriod configuration data x.val,
        (candidateAReducedBRSTMinimal_project_domain_iff period hPeriod configuration data analysis realization
  ...
  operator_intertwining_of_pairing _ _ _
    ...
    (fun z hz => (candidateAReducedBRSTMinimal_project_domain_iff period hPeriod configuration data analysis realization
      plusBase minusBase hBase hCenter physical hMetric hWeights z).mpr hz)
    (candidateAReducedBRSTMinimal_pairing_project period hPeriod configuration data analysis realization
...
theorem candidateAReducedBRSTMinimal_zero_iff
    (x : (candidateACoupledBRSTMinimal period hPeriod configuration data analysis realization
      plusBase minusBase hBase hCenter physical).domain) :
    candidateAReducedBRSTMinimal period hPeriod configuration data analysis realization
      plusBase minusBase hBase hCenter physical hMetric hWeights
  ...
  · intro h
    ...
    intro y
    have hp := candidateAReducedBRSTMinimal_pairing_project period hPeriod configuration data analysis realization
  ...
  · intro h
    rw [candidateAReducedBRSTMinimal_intertwining, h, map_zero]

variable (pair test : GlobalCandidateADiagonalDiffeomorphismBRSTState period hPeriod ×
  GlobalPairedAbelianBRSTState period hPeriod)

theorem candidateAReducedBRSTMinimal_smooth_mem :
  ...
  (candidateAReducedBRSTMinimal_hasCore period hPeriod configuration data analysis realization
    plusBase minusBase hBase hCenter physical hMetric hWeights).le_domain ⟨pair, rfl⟩

theorem candidateAReducedBRSTMinimal_smooth_pairing_project :
    inner Real
      (candidateAReducedBRSTMinimal period hPeriod configuration data analysis realization
        plusBase minusBase hBase hCenter physical hMetric hWeights
        ⟨candidateAReducedBRSTSmooth period hPeriod configuration data pair,
          candidateAReducedBRSTMinimal_smooth_mem period hPeriod configuration data analysis realization
            plusBase minusBase hBase hCenter physical hMetric hWeights pair⟩)
      (candidateAReducedBRSTSmooth period hPeriod configuration data test) =
    inner Real
      (candidateACoupledBRSTMinimal period hPeriod configuration data analysis realization
        plusBase minusBase hBase hCenter physical
        ⟨candidateACoupledBRSTSmooth period hPeriod configuration data pair,
          candidateACoupledBRSTMinimal_smooth_mem period hPeriod configuration data analysis realization
            plusBase minusBase hBase hCenter physical pair⟩)
      (candidateACoupledBRSTSmooth period hPeriod configuration data test) :=
  candidateAReducedBRSTMinimal_pairing_project period hPeriod configuration data analysis realization
    plusBase minusBase hBase hCenter physical hMetric hWeights
    ⟨candidateACoupledBRSTSmooth period hPeriod configuration data pair,
      candidateACoupledBRSTMinimal_smooth_mem period hPeriod configuration data analysis realization
...
/-- The quotient minimal core realizes the original augmented Hessian of both genuine BRST fields. -/
theorem candidateAReducedBRSTMinimal_smooth_actual :
    inner Real
      (candidateAReducedBRSTMinimal period hPeriod configuration data analysis realization
        plusBase minusBase hBase hCenter physical hMetric hWeights
        ⟨candidateAReducedBRSTSmooth period hPeriod configuration data pair,
      ...
      (strongAugmentedRiesz (measure := measure) period hPeriod configuration data analysis realization
        ...
        (candidateACoupledBRSTOriginal period hPeriod configuration data analysis
          (globalCandidateADiagonalDiffeomorphismOffShellSmoothEmbedding period hPeriod
            (globalCandidateAMetricBySector period hPeriod data) pair.1) pair.2))
      (candidateACoupledBRSTOriginal period hPeriod configuration data analysis
        (globalCandidateADiagonalDiffeomorphismOffShellSmoothEmbedding period hPeriod
          (globalCandidateAMetricBySector period hPeriod data) test.1) test.2) := by
  rw [candidateAReducedBRSTMinimal_smooth_pairing_project]
  exact candidateACoupledBRSTMinimal_smooth_actual period hPeriod configuration data analysis realization
    plusBase minusBase hBase hCenter physical pair test

end
end
end P0EFTJanusProgramPT12CandidateAReducedBRSTMinimalIntertwining4D
end JanusFormal
