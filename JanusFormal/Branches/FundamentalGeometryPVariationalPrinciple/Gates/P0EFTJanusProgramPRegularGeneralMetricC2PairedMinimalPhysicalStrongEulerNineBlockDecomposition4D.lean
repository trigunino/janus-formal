...
/-! # Nine-block decomposition of the strong local Euler operator -/

namespace JanusFormal
namespace P0EFTJanusProgramPRegularGeneralMetricC2PairedMinimalPhysicalStrongEulerNineBlockDecomposition4D
...
/-- The authentic strong Euler covector is exactly the sum of the nine block
covectors at every admissible point. -/
theorem regularGeneralMetricC2PairedMinimalPhysicalStrongEuler_eq_nineBlockSum
  ...
  let chart :=
    regularGeneralMetricC2PairedMinimalPhysicalStrongLocalVariationalChart
      period hPeriod configuration data analysis realization plusBase minusBase
        hBase measure
  change actionGradient
      (fullCoupledAction
        (regularGeneralMetricC2PairedMinimalPhysicalAdmissibleActionBlocks
          period hPeriod configuration.physical couplings data plusBase minusBase
            hBase measure)) point = _
  exact fullCoupledAction_gradient_apply_eq_blockSum _ point
    (fullCoupledC2WithinAt_toAt (chart.blocksC2Within point hPoint)
      chart.isOpen_domain hPoint)

/-- Gate marker: the authentic strong Euler equation has its exact nine-block
decomposition. -/
theorem regular_general_metric_c2_paired_minimal_physical_strong_euler_nine_block_gate
    {couplings : GlobalCandidateAActionCouplings}
    {NonNullFace NullFace : Type*}
    [Fintype NonNullFace] [Fintype NullFace]
    (configuration : GlobalGaugeFixedFieldConfiguration period hPeriod)
    ...
    regularGeneralMetricC2PairedMinimalPhysicalStrongEulerLagrangeOperator
      ...
      fullCoupledEulerBlockSum
        (regularGeneralMetricC2PairedMinimalPhysicalAdmissibleActionBlocks
          period hPeriod configuration.physical couplings data plusBase minusBase
            hBase measure) point :=
  regularGeneralMetricC2PairedMinimalPhysicalStrongEuler_eq_nineBlockSum period
    hPeriod configuration data analysis realization plusBase minusBase hBase
      measure point hPoint

end
end P0EFTJanusProgramPRegularGeneralMetricC2PairedMinimalPhysicalStrongEulerNineBlockDecomposition4D
end JanusFormal
