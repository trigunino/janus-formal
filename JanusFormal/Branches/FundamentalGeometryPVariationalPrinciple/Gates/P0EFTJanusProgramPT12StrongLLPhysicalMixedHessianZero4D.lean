...
pure LL direction, hence none against a matter--LL direction. -/

namespace JanusFormal
namespace P0EFTJanusProgramPT12StrongLLPhysicalMixedHessianZero4D
...
pure smooth LL second slot vanishes. -/
theorem strong_LL_physical_mixed_hessian_zero
    ...
    (test : RegularGeneralMetricC2PairedMinimalPhysicalStrongLLTest period
      hPeriod) :
...
/-- The seven physical Hessian also annihilates a sum of pure smooth matter
and pure smooth LL directions. -/
theorem strong_matter_LL_physical_mixed_hessian_zero
    {couplings : GlobalCandidateAActionCouplings}
    {NonNullFace NullFace : Type*}
    [Fintype NonNullFace] [Fintype NullFace]
    (configuration : GlobalGaugeFixedFieldConfiguration period hPeriod)
    ...
    (hPoint : point ∈
      regularGeneralMetricC2PairedMinimalPhysicalAdmissibleDomain period
        hPeriod configuration.physical plusBase minusBase)
    (matter : ProgramPPrimitiveSpinCMatterSmoothField period hPeriod)
    (ll : RegularGeneralMetricC2PairedMinimalPhysicalStrongLLTest period
      hPeriod) :
    globalCandidateALocalPhysicalHessian period hPeriod
      (regularGeneralMetricC2PairedMinimalPhysicalStrongLocalVariationalChart
        period hPeriod configuration data analysis realization plusBase
      ...
      point other
        (regularGeneralMetricC2PairedMinimalPhysicalStrongSpinCMatterDirection
            period hPeriod configuration.physical matter +
          regularGeneralMetricC2PairedMinimalPhysicalStrongLLDirection period
            hPeriod configuration.physical ll) = 0 := by
  calc
    _ =
        globalCandidateALocalPhysicalHessian period hPeriod
            (regularGeneralMetricC2PairedMinimalPhysicalStrongLocalVariationalChart
          ...
          globalCandidateALocalPhysicalHessian period hPeriod
            ...
            point other
              (regularGeneralMetricC2PairedMinimalPhysicalStrongLLDirection period
                hPeriod configuration.physical ll) := by
      apply map_add
    _ = 0 := by
      rw [strong_spinC_physical_mixed_hessian_zero period hPeriod configuration
        data analysis realization plusBase minusBase hBase measure point other
          hPoint matter,
        strong_LL_physical_mixed_hessian_zero period hPeriod configuration data
          analysis realization plusBase minusBase hBase measure point other hPoint
            ll,
        add_zero]

end
end P0EFTJanusProgramPT12StrongLLPhysicalMixedHessianZero4D
end JanusFormal
