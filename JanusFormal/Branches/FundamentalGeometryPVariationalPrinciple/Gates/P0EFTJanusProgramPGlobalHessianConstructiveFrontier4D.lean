...
be reached through either of two equivalent analytic organizations:
...
Both routes share the same action-level matter--LL quadratic chart and the
same finite-defect parametrix reduction of the Fredholm estimates.  No new
action, field, D10 direction, completion, or terminal physical hypothesis is
introduced here.
-/
...
/-- The two constructive terminal routes are both available from this façade. -/
