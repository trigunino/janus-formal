...
def physicalKernels
  ...
  (coherent.toD11LinearPullbackTransport period hPeriod input natural).physicalKernels
    period hPeriod input natural
...
def physicalNamedKernelFamilyClosure
    ...
    GlobalHessianPreferredFiveSectorNamedKernelFamilyClosure4D
      period hPeriod configuration data analysis einsteinScale hTransverse family
        chartBound Metric Abelian Matter Longitudinal Boundary ZeroMode fold Index :=
  (coherent.toD11LinearPullbackTransport period hPeriod input natural).physicalNamedKernelFamilyClosure
    period hPeriod input natural
...
def physicalResolvedKernelFamily
  ...
  (coherent.toD11LinearPullbackTransport period hPeriod input natural).physicalResolvedKernelFamily
    period hPeriod input natural
...
def physicalRegularity
    ...
    GlobalHessianPreferredFiveSectorDifferentiableNamedKernelFamily4D
      period hPeriod
        (coherent.physicalNamedKernelFamilyClosure period hPeriod input natural) :=
  (coherent.toD11LinearPullbackTransport period hPeriod input natural).physicalRegularity
    period hPeriod input natural
...
theorem global_hessian_preferred_five_sector_D11_coherent_pullback_transport_gate
    ...
    (∀ first second third,
      (coherent.coherentPullback.transport first second).trans
          (coherent.coherentPullback.transport second third) =
