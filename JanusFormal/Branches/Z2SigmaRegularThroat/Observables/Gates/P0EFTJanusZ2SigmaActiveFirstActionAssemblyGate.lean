...
import JanusFormal.Branches.Z2SigmaRegularThroat.BoundaryDynamics.Gates.P0EFTJanusZ2SigmaCountertermBoundaryActionFunctionalGate
...
structure ActiveFirstActionAssemblyGate where
  z4CMBNonEvidencePolicyImported : Prop
...
def activeFirstActionLedgerDeclared
  ...
  g.z4CMBNonEvidencePolicyImported /\
