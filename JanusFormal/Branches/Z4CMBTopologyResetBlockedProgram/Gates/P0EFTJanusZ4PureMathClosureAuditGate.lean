import JanusFormal.Branches.P0EFTOrbifoldHolstPrototypeProgram.Gates.P0EFTGlobalTopologyMasterLock
...
theorem scaffold_without_global_theorems_blocks_no_fit
  ...
  rcases h with âŸ¨_, _, _, _, hClosed, hNoFitâŸ©
  exact âŸ¨hClosed, hNoFitâŸ©
