...
theorem no_aether_instability_reintroduced_by_scalar
  ...
  rcases c.setupClosed with
    âŸ¨hScalarMode, hScalarConstraint, hOrbifold, hQuadratic, hMass, hHamiltonian, hMomentumâŸ©
...
theorem no_aether_instability_reintroduced_by_vector
  ...
  rcases c.setupClosed with
    âŸ¨hVectorMode, hOrbifold, hQuadratic, hMassSetup, hHamiltonian, hMomentum, hAetherIncludedâŸ©
