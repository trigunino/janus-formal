...
theorem scalar_setup_from_exact_closed
  ...
  rcases h with
    âŸ¨hSvt, hConstraints, hBoundary, hQuadratic,
      hRadion, hMembrane, hAetherâŸ©
...
theorem sample_exact_scalar_vector_certificate :
  ...
  refine âŸ¨
    { params := sampleExactScalarVectorParams
      ...
      vectorMassNonnegative := ?_ }âŸ©
  Â· norm_num [scalarVectorExactDerivationClosed, sampleExactScalarVectorParams]
  Â· norm_num [scalarAlphaExact, vectorAlphaExact, sampleExactScalarVectorParams]
  Â· norm_num [scalarBetaExact, sampleExactScalarVectorParams]
  Â· norm_num [scalarMassSquaredExact, sampleExactScalarVectorParams]
  Â· norm_num [vectorAlphaExact, sampleExactScalarVectorParams]
  Â· norm_num [vectorBetaExact, sampleExactScalarVectorParams]
  Â· norm_num [vectorMassSquaredExact, sampleExactScalarVectorParams]
