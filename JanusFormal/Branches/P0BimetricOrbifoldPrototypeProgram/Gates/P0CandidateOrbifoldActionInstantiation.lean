...
theorem closed_candidate_gives_gauge_like_aether
  ...
  rcases h with
    âŸ¨_hCartan, _hPlus, _hMinus, _hPotential, hGauge,
      hNormal, _hHR, _hDgrt, _hGHY, _hIsrael, _hBg, _hMetric, _hOrientâŸ©
  exact âŸ¨hGauge, hGauge, hGauge, hGauge, hGauge, hGauge, hNormalâŸ©
...
theorem closed_candidate_gives_radion_tetrad_orientation
  ...
  rcases h with
    âŸ¨hCartan, _hPlus, hMinus, _hPotential, _hGauge,
      hNormal, _hHR, _hDgrt, _hGHY, _hIsrael, _hBg, _hMetric, hOrientâŸ©
  exact âŸ¨hMinus, hMinus, hMinus, hOrient, hNormal, hOrient, hOrientâŸ©
...
theorem candidate_term_system_closed
  ...
  exact âŸ¨âŸ¨rfl, rflâŸ©, rfl, rfl, rflâŸ©
...
theorem candidate_metric_sign_note
  ...
  exact âŸ¨h.right.right.right.right.right.right.right.right.right.right.right.left,
    h.right.right.right.right.right.right.right.right.right.right.right.rightâŸ©
