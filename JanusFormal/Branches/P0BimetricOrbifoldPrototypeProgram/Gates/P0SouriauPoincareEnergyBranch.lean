...
theorem souriau_route_closes_negative_energy_orientation
  ...
  rcases c.negativeOrbitAvailable with
    âŸ¨hFull, _hOrbit, _hMoment, hAnti, _hNeg, _hQuant, hRepâŸ©
  rcases c.confinement with
    âŸ¨_hSheet, _hConfine, _hNoMix, _hMetric, hBranch, hStableâŸ©
  exact âŸ¨hAnti, hFull, hRep, hBranch, hStableâŸ©
...
theorem missing_branch_selection_blocks_souriau_certificate
  ...
  intro hCert
  rcases hCert with âŸ¨cert, hDataâŸ©
  rcases hData with âŸ¨_hSource, hConfinementâŸ©
