...
theorem source_action_and_uniqueness_give_bridge_selection
  ...
  exact âŸ¨hSource, hEquation, hUnique, hSameâŸ©
...
theorem full_source_obligations_give_conditional_prediction
  ...
  rcases hSource with
    âŸ¨hAction, hVariation, hNoether, hMeasure, hBridgePresent, hPressurePiPresentâŸ©
  exact conditional_closure_from_dynamic_action_axioms
    ...
    âŸ¨hAction,
      hVariation,
      âŸ¨âŸ¨hAction, hVariation, hNoether, hMeasure, hBridgePresent, hPressurePiPresentâŸ©,
        hEquation, hUnique, hSameâŸ©,
      hSame,
      hB4,
      hPressurePi,
      hNoether,
