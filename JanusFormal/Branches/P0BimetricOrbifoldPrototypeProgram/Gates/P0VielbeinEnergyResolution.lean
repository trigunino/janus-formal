...
theorem vielbein_closure_gives_projection_nondegeneracy
  ...
  exact âŸ¨h.right.right.right.right.left, h.right.right.right.right.right.leftâŸ©
...
theorem resolution_closes_projection_guards
  ...
  exact
    âŸ¨vielbein_closure_gives_projection_nondegeneracy r.vielbeinData h.left,
      quantum_energy_closure_gives_negative_orientation r.energyData h.rightâŸ©
