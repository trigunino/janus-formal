...
theorem certificate_derives_no_gradient
  ...
  exact âŸ¨c.betaPositive, c.plusSpeedPositive,
    âŸ¨c.alphaPositive, c.betaPositive, c.minusSpeedPositiveâŸ©âŸ©
