...
theorem closed_bimembrane_gives_minus_confinement
  ...
  rcases h with
    âŸ¨_hPlus, hMinus, _hInterface, hTopo, _hLeak, hNoMix,
      hMetric, hBranch, hStable, _hDefect, _hCharge, _hPTâŸ©
  exact âŸ¨hMinus, hTopo, hNoMix, hMetric, hBranch, hStableâŸ©
...
theorem closed_bimembrane_gives_topology_ready
  ...
  rcases h with
    âŸ¨_hPlus, _hMinus, _hInterface, _hTopo, hLeak, _hNoMix,
      _hMetric, _hBranch, _hStable, hDefect, hCharge, hPTâŸ©
  exact âŸ¨hDefect, hLeak, hCharge, hPTâŸ©
