import JanusFormal.Branches.Z4HistoricalProgram.Gates.P0EFTJanusZ4MasterRevisedSourceLevelRegenerationGate
...
theorem revised_carrier_projection_allows_next_diagnostic_only
  ...
  rcases h with ⟨_, _, _, _, _, _, hNoRerun, hNoPromotion, _, _⟩
  exact ⟨hGate, hNoRerun, hNoPromotion⟩
