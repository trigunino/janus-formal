import JanusFormal.Branches.Z4HistoricalProgram.Gates.P0EFTJanusZ4MasterDiagnosticLikelihoodTrialGate
...
theorem policy_blocks_official_planck_until_wrapper_handshake
  ...
  rcases h with ⟨_, _, _, _, _, _, _, hPlanck, _, hClaim, _, _⟩
  exact ⟨hPlanck, hClaim⟩
