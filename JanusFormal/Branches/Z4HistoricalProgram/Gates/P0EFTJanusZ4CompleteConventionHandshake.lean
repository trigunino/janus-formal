import JanusFormal.Branches.Z4HistoricalProgram.Gates.P0EFTJanusZ4CompleteCMBSolverStack
...
theorem convention_handshake_is_not_validation
  ...
  rcases h with ⟨_, _, _, hDiagnostic, hObserved, _, hFull⟩
  exact ⟨hDiagnostic, hObserved, hFull⟩
