import JanusFormal.Branches.Z4HistoricalProgram.Gates.P0EFTJanusZ4MasterPhotonBaryonMatchingGate
...
theorem diagnostic_components_do_not_validate_planck
  ...
  rcases h with
    ⟨_, _, _, _, _, _, hLikelihood, hRetry, _, _, _, hFull⟩
  exact ⟨hLikelihood, hRetry, hFull⟩
