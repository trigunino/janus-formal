import JanusFormal.Branches.Z4HistoricalProgram.Gates.P0EFTJanusZ4StandaloneTEEEAcquisitionGate
...
theorem blocked_handshake_forbids_decomposition_trial
  ...
  rcases h with ⟨_, _, _, _, _, hNoTrial, hNoFull⟩
  exact ⟨hNoTrial, hNoFull⟩
